...
abstract class WebSocketServer
{
    ...
    {
        $this->stdout("Attemping to start server on $addr:$port");
    ...
    protected function _tick()
    {
        ...
        foreach ($this->heldMessages as $key => $hm)
        {
            ...
            if (!$found)
            {
                ...
                // AMM 2021-11-06 DEBUG
                $this->stdout("User has messages but user not connected. Drop messages.");
                unset($this->heldMessages[$key]);
            }
        }
    }
    ...
    public function run()
    {
        ...
        while (true)
        {
            ...
            {
                // AMM 2021-11-06 DEBUG
                $this->stdout("Client list empty. Adding master");
                $this->sockets['m'] = $this->master;
            }
            $read = $this->sockets;
            $write = $except = null;
            ...
            foreach ($read as $socket)
            {
                ...
                else
                {
                    ...
                    // AMM 2021-11-06 DEBUG
                    $this->stdout("Num Bytes Received: " . $numBytes);
                    if ($numBytes === false)
                    {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            // AMM 2021-11-06 DEBUG
                            $this->stdout("About to split packets");
    ...
    protected function doHandshake($user, $buffer)
    {
        ...
        if (isset($headers['get']))
        {
            ...
            // AMM 2021-11-06 DEBUG
            $this->stdout("GET method is used");
        }
        else
        {
        ...
        if (isset($handshakeResponse))
        {
            ...
            // AMM 2021-11-06 DEBUG
            $this->stdout("Wrote handshake response");
            return;
        }
